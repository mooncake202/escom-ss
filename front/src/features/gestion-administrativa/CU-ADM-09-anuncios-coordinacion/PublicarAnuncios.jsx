...
export default function PublicarAnuncios() {
  const { C } = useTheme();
  const {
    coordinacion, anuncios, modo, anuncioActivo, form, errores, toast,
  ...
  return (
    <DashboardLayout
      ...
      subtitulo="CU-ADM-09 · Coordinación"
      rol="coordinacion"
        ...
        <div style={{
          ...
          {anuncios.length === 0 && (
            <div style={{ padding: "3rem 2rem", textAlign: "center" }}>
              ...
              <p style={{ margin: 0, fontSize: 13, color: C.textMuted }}>
                Usa "Nuevo anuncio" para publicar el primer comunicado institucional.
              </p>
            </div>
          )}
