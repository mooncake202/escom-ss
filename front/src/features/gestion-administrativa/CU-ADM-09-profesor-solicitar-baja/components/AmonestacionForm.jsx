      ...
      <div style={{ padding: "1.25rem 1.5rem" }}>
        ...
        <div style={{ marginBottom: "1.25rem" }}>
          <label style={{
            ...
            Observaciones <span style={{ color: C.danger }}>*</span>
          </label>
          <textarea
            value={observaciones}
            onChange={onObservacionesChange}
            placeholder="Describe los motivos de la amonestación y las expectativas de mejora para el alumno..."
            rows={5}
            style={{
              width: "100%", padding: "10px 14px", boxSizing: "border-box",
              background: C.bgInput,
              border: `1px solid ${errores.observaciones ? C.danger : C.borderDefault}`,
