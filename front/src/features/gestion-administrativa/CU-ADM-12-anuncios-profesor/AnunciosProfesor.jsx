...
import { DestinatariosBar }      from "./components/DestinatariosBar.jsx";
import { AnuncioForm }           from "./components/AnuncioForm";
import { AnuncioItem }           from "./components/AnuncioItem";
import { useAnunciosProfesor }   from "./hooks/useAnunciosProfesor";

export default function AnunciosProfesor() {
  const { C } = useTheme();
  const {
    profesor, tieneAlumnos, alumnosAsignados,
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 780, margin: "0 auto", width: "100%" }}>
        ...
        {/* ── Empty state: sin alumnos asignados ─────────────────────────── */}
        {!tieneAlumnos ? (
          <div style={{
            ...
            <div style={{
              ...
              {anuncios.length === 0 && (
                <div style={{ padding: "3rem 2rem", textAlign: "center" }}>
                  ...
                  <p style={{ margin: 0, fontSize: 13, color: C.textMuted }}>
                    Usa "Nuevo anuncio" para comunicarte con tus alumnos.
                  </p>
                </div>
              )}
