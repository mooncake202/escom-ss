  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1100, margin: "0 auto", width: "100%" }}>
        ...
        {/* Pestañas — SIEMPRE visibles, no dependen de "cargando" */}
        ...
        {/* Filtros — SIEMPRE visibles, no dependen de "cargando" */}
        ...
        {/* Solo la LISTA de resultados se apaga mientras carga */}
        {cargando ? (
                  ...
                  <div style={{
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "0.75rem", marginBottom: "1rem" }}>
                      <div style={{ flex: 1 }}>
                        ...
                        {seleccionado.programaSISS && (
                          <p style={{ margin: 0, fontSize: 12, color: C.textDisabled }}>Programa SISS: {seleccionado.programaSISS}</p>
                        )}
                    ...
                    <Section label="Descripción y actividades">
