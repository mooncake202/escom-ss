                  ...
                  <div style={{
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "1rem" }}>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        {!editando && seleccionada.programaSISS && (
                          <p style={{ margin: "0 0 2px", fontSize: 12, color: C.textDisabled }}>
                            Programa SISS: {seleccionada.programaSISS}
                          </p>
                        )}
                        {!editando && seleccionada.tituloSISS && (
                          <p style={{ margin: "0 0 10px", fontSize: 12, color: C.textDisabled }}>
                            Actividad SISS: {seleccionada.tituloSISS}
                          </p>
                        )}
                        {!editando && (
                    ...
                    {!editando && (
                      <>
                        ...
                        {seleccionada.descripcion && (
                          <div>
                            <p style={{ margin: "0 0 6px", fontSize: 11, fontWeight: 700, color: C.textDisabled, textTransform: "uppercase", letterSpacing: "0.07em" }}>Descripción y actividades</p>
