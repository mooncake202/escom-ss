...
const MOCK_REGISTROS_POR_ALUMNO = {
  1: [
    ...
    { id: "a1", tipo: "actividad", fecha: "2026-03-15", titulo: "Análisis de requerimientos", descripcion: "Levantar requerimientos del sistema.", entregable: "Documento IEEE 830", estado: "En progreso", progreso: 75 },
    { id: "a2", tipo: "actividad", fecha: "2026-03-18", titulo: "Diseño de base de datos", descripcion: "Modelar el esquema ER.", entregable: "Diagrama ER y script SQL", estado: "En progreso", progreso: 60 },
    { id: "a3", tipo: "actividad", fecha: "2026-03-10", titulo: "Investigación de frameworks", descripcion: "Comparar frameworks frontend.", entregable: "Documento comparativo", estado: "Completada", progreso: 100 },
  ],
  2: [
    ...
    { id: "a4", tipo: "actividad", fecha: "2026-03-10", titulo: "Preparación del dataset", descripcion: "Limpiar y normalizar los datos.", entregable: "Dataset limpio CSV", estado: "Completada", progreso: 100 },
  ],
};
...
export function useHistorial(rol = "alumno") {
  ...
  // El alumno siempre ve su id=1, profesor/coord eligen
  const idActivo = rol === "alumno" ? 1 : alumnoVisto?.id ?? 1;
  const registrosBase = MOCK_REGISTROS_POR_ALUMNO[idActivo] ?? [];
