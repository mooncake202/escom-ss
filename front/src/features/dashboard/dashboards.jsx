...
const EVENTOS_POR_ROL = {
  ...
  // 'reporte:nuevo': un alumno envió un reporte mensual para revisión (REP-01); 'reporte:actualizado': Coordinación
  // validó o rechazó un reporte que él aprobó (REP-06).
  profesor: ["solicitud:nueva", "resumen:actualizado", "reporte:nuevo", "reporte:actualizado"],
  coordinador: [
    "documentacion:pendiente", "documentacion:decidida",
    "expediente:pendiente_revision", "expediente:decidido",
    "reporte:nuevo", // un profesor aprobó un reporte y espera validación (REP-05)
  ],
};
