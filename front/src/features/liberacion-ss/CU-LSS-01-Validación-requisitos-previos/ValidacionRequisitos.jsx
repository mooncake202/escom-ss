  ...
  if (enviado) {
    return (
      <ProcesoLSSLayout 
        ...
        subtitulo="Validación de requisitos"
        rol="alumno"
      ...
      <div style={{ maxWidth: 620, margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{
            ...
            ✅ Reportes mensuales y global registrados
          </div>
          ...
          <div style={{
            ...
            <label style={{ display: "flex", gap: 10, cursor: "pointer" }}>
              ...
              <span style={{ fontSize: 13 }}>
                Confirmo que mis reportes han sido validados en el SISS
              </span>
            </label>
          </div>
          ...
          <div style={{
            ...
            <label style={{ display: "flex", gap: 10, cursor: "pointer" }}>
              ...
              />
              <span style={{ fontSize: 13 }}>
                Solicito que se validen mis reportes en el SISS
              </span>
            </label>
          </div>
