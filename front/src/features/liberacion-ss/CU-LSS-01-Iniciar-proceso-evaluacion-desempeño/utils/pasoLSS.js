...
const PASO_POR_ESTADO = {
  evaluacion_solicitada: 2, // CU-LSS-01 (esta tarea) — esperando evaluación del profesor
  // TODO(LSS-02+): agregar aquí el/los estado(s) reales del paso 3 (Carta término) cuando se construya ese CU
