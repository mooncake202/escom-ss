...
// `descripcion={false}` oculta la nota explicativa (la usa REP-04 con su texto original por omisión).
export function AvanceActividades({ avances, descripcion = true, C }) {
  return (
    <div style={{
      ...
      <p style={{ margin: descripcion ? "0 0 3px" : "0 0 1rem", fontSize: 13, fontWeight: 700, color: C.textPrimary }}>
